...
expName = 'lexical design task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\91982\\Downloads\\Psychopy\\Solo project\\lexical frequency task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Following experiment has a list of words \n\nYou have to memorize as many words as possible. When you have finished remembering the words, you will be provided with a text box and you have to write down as many words as you can remember',
        font='Arial',
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text='Write down as many words as you can remember',
        font='Arial',
    ...
    InstructionsComponents = [text, button_2]
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('words list.xlsx'),
    ...
    for thisTrial in trials:
        ...
        word_text.setText(words_list)
        # reset button to account for continued clicks & clear times on/off
        button.reset()
        # keep track of which components have finished
        trialComponents = [word_text, button]
        ...
        while continueRoutine:
            ...
            if word_text.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('trials_2.started', globalClock.getTime(format='float'))
    textbox.reset()
    # reset button_3 to account for continued clicks & clear times on/off
    button_3.reset()
    # keep track of which components have finished
    trials_2Components = [text_2, textbox, button_3]
    ...
    for thisComponent in trials_2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('trials_2.stopped', globalClock.getTime(format='float'))
    ...
    thisExp.nextEntry()
    # the Routine "trials_2" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
